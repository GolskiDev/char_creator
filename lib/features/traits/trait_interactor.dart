...
class TraitInteractor {
    List<TraitValueModel> getTraitValueModels(
      ...
      if(traitKeys != null){
        result = result.where((traitValueModel) => _filterByTraitKeys(traitKeys, traitValueModel));
      }
      if(isSelected != null){
        result = result.where((traitValueModel) => _filterByIsSelected(isSelected, traitValueModel));
      }
